...
akbarvpnnnn="raw.githubusercontent.com/Tarap-Kuhing/mod/main/stunnel5"
...
state=Indonesia
locality=Kalimantan
organization=Kandangan
organizationalunit=Script
...
wget -O /etc/squid/squid.conf "https://${akbarvpn}/squid.conf"
