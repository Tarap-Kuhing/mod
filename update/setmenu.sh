...
echo -e "$yy 2$y.  Renew Certificate XRAYS Account"
...
echo -e "$yy 11$y. Restart All Service"
echo -e "$yy 12$y. Speedtest VPS"
echo -e "$yy 13$y. Displaying System Information"
echo -e "$yy 14$y. Info Script Auto Install"
echo -e "$yy 15$y. Menu"
echo -e "$yy 16$y. Exit"
echo -e "$y-------------------------------------------------------------$wh"
echo -e ""
